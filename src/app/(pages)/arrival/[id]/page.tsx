...
// import { add } from "@/app/Redux/feature/cartSlice";
...
// // Star rating array
// const star = Array(5).fill(<FaStar key={Math.random()} />);

// interface Iproducts {
//   image: string[]; // Ensure this is handled as an array
//   discountPercent: number;
//   isNew: boolean;
//   name: string;
//   description: string;
...
//             id: slug._id,
//             name: slug.name,
//             image: slug.image[0], // Ensure it's accessing the first image correctly
//             price: slug.price,
//             size: slug.sizes.length ? slug.sizes[0] : "N/A",
//             color: slug.colors.length ? slug.colors[0] : "N/A",
//             qty: 1,
//             discount: slug.discountPercent,
//           });
//         }
...
//             {product.image && (
//               <Image
//                 src={product.image[0]} // Display first image as main
//                 className="w-full h-full sm:mt-3 rounded-[20px]"
//                 alt={product.name}
//                 width={500}
//                 height={500}
      ...
      try {
        ...
        if (!slug) {
          ...
          setCartItem({
            id: slug._id,
            name: slug.name,
            image: slug.image?.[0] || "", // Ensure an image is available
            price: slug.price,
            size: slug.sizes.length ? slug.sizes[0] : "N/A",
            color: slug.colors.length ? slug.colors[0] : "N/A",
            qty: 1,
